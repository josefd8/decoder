...
public class interpretadorOrdenesConsola implements Runnable{
	...
	public void run() {
		...
		while (true) {
			...
			case "opciones":
				System.out.println(" ondebug:   Muestra las operaciones en curso.");
				System.out.println(" offdebug:  Apaga la salida en pantalla de las operaiones en curso.");
				System.out.println(" finalizar: Fuerza la desconexion de todos los equipos (TCP).");
				System.out.println(" estado:    Equipos conectados (TCP) / paquetes recibidos.");
				System.out.println(" reiniciar: Fuerza el reinicio del servidor.");
				System.out.println(" salir:     Finaliza el servidor.");
				break;
